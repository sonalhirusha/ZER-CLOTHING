...
const PRODUCTS = [
  // To add a real photo: set img (front) and img2 (back) to your file paths,
  // e.g. img: "assets/images/products/acid-hoodie-front.jpg"
  { id: "z-acid-hood-blk", name: "Acid Wash Hoodie — Onyx", img: "", img2: "", cat: "Acid Wash Hoodies", collection: "Acid Wash", price: 8900, was: 11500, rating: 4.9, reviews: 214, colors: ["#0a0a0a","#3a3a3a"], sizes: ["S","M","L","XL","XXL"], oos: ["XXL"], tags: ["Bestseller"], badge: "Bestseller", popularity: 98, date: 20260520, label: "ACID WASH HOODIE" },
  { id: "z-over-tee-bone", name: "Oversized Tee — Bone", img: "", img2: "", cat: "Oversized Tees", collection: "Essentials", price: 4200, was: 0, rating: 4.8, reviews: 168, colors: ["#f5f5f5","#0a0a0a","#7d7d7d"], sizes: ["S","M","L","XL"], oos: [], tags: ["New"], badge: "New", popularity: 91, date: 20260601, label: "OVERSIZED TEE" },
  { id: "z-custom-tee-blk", name: "Custom Print Tee — Black", img: "", img2: "", cat: "Custom T-Shirts", collection: "Custom", price: 3900, was: 0, rating: 4.7, reviews: 322, colors: ["#0a0a0a","#f5f5f5"], sizes: ["S","M","L","XL","XXL"], oos: [], tags: ["Customisable"], badge: "Designed By You", popularity: 95, date: 20260512, label: "CUSTOM TEE" },
