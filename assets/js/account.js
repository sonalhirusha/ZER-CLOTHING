...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function panels() {
    ...
    return {
      ...
      wishlist: `<h2 class="h-md mb-m">Wishlist</h2>${wl.length ? `<div class="grid cols-3">${wl.map(productCard).join("")}</div>` : `<p class="muted">Your wishlist is empty. <a href="shop.html" class="link-underline">Discover pieces</a></p>`}`,
